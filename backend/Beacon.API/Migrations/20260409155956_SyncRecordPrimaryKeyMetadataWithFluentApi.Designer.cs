...
namespace Beacon.API.Migrations
{
    ...
    [Migration("20260409155956_SyncRecordPrimaryKeyMetadataWithFluentApi")]
    partial class SyncRecordPrimaryKeyMetadataWithFluentApi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Beacon.API.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.Donation", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.DonationAllocation", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.InKindDonationItem", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.InterventionPlan", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.Partner", b =>
                {
                    ...
                    b.HasIndex("IdentityUserId")
                        .HasDatabaseName("ix_partners_identity_user_id");

                    b.ToTable("partners", (string)null);
                });

            modelBuilder.Entity("Beacon.API.Models.PartnerAssignment", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.PublicImpactSnapshot", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.Resident", b =>
                {
                    b.Property<int>("ResidentId")
                        .HasColumnType("integer")
                        .HasColumnName("resident_id");
            ...
            modelBuilder.Entity("Beacon.API.Models.Safehouse", b =>
                {
                    b.Property<int>("SafehouseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Beacon.API.Models.SafehouseMonthlyMetric", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.SocialMediaPost", b =>
                {
            ...
            modelBuilder.Entity("Beacon.API.Models.Supporter", b =>
                {
                    b.Property<int>("SupporterId")
                        .HasColumnType("integer")
                        .HasColumnName("supporter_id");
                    ...
                    b.HasIndex("IdentityUserId")
                        .HasDatabaseName("ix_supporters_identity_user_id");
            ...
            modelBuilder.Entity("Beacon.API.Models.Donation", b =>
                {
                    b.HasOne("Beacon.API.Models.SocialMediaPost", "ReferralPost")
                        .WithMany("Donations")
                        .HasForeignKey("ReferralPostId")
                        .HasConstraintName("fk_donations_social_media_posts_referral_post_id");

                    b.HasOne("Beacon.API.Models.Supporter", "Supporter")
                        .WithMany("Donations")
            ...
            modelBuilder.Entity("Beacon.API.Models.DonationAllocation", b =>
                {
                    b.HasOne("Beacon.API.Models.Donation", "Donation")
                    ...
                    b.HasOne("Beacon.API.Models.Safehouse", "Safehouse")
                        .WithMany("DonationAllocations")
            ...
            modelBuilder.Entity("Beacon.API.Models.EducationRecord", b =>
                {
                    b.HasOne("Beacon.API.Models.Resident", "Resident")
            ...
            modelBuilder.Entity("Beacon.API.Models.Partner", b =>
                {
                    b.HasOne("Beacon.API.Data.ApplicationUser", "IdentityUser")
                        .WithMany()
                        .HasForeignKey("IdentityUserId")
                        .HasConstraintName("fk_partners_users_identity_user_id");
            ...
            modelBuilder.Entity("Beacon.API.Models.PartnerAssignment", b =>
                {
                    b.HasOne("Beacon.API.Models.Partner", "Partner")
            ...
            modelBuilder.Entity("Beacon.API.Models.Supporter", b =>
                {
                    b.HasOne("Beacon.API.Data.ApplicationUser", "IdentityUser")
                        .WithMany()
                        .HasForeignKey("IdentityUserId")
                        .HasConstraintName("fk_supporters_users_identity_user_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Beacon.API.Data.ApplicationUser", null)
                        .WithMany()
